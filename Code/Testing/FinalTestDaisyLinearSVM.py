...
while running:
	...
	#Load All DT's
	UKIDT = pickle.load(open("1UKIDaisyProb.LinearSVC", "rb"))
	LReDT = pickle.load(open("2LReDaisyProb.LinearSVC", "rb"))
	MinDT = pickle.load(open("3MinDaisyProb.LinearSVC", "rb"))
	HRenDT = pickle.load(open("4HRenDaisyProb.LinearSVC", "rb"))
	ERenDT = pickle.load(open("5ERenDaisyProb.LinearSVC", "rb"))
	PopDT = pickle.load(open("6PopDaisyProb.LinearSVC", "rb"))
	CFPDT = pickle.load(open("7CFPDaisyProb.LinearSVC", "rb"))
	RocDT = pickle.load(open("8RocDaisyProb.LinearSVC", "rb"))
	CubDT = pickle.load(open("9CubDaisyProb.LinearSVC", "rb"))
	NAPDT = pickle.load(open("10NAPDaisyProb.LinearSVC", "rb"))
	NRDT = pickle.load(open("11NRDaisyProb.LinearSVC", "rb"))
	AEDT = pickle.load(open("12AEDaisyProb.LinearSVC", "rb"))
	BDT = pickle.load(open("13BDaisyProb.LinearSVC", "rb"))
	ANMDT = pickle.load(open("14ANMDaisyProb.LinearSVC", "rb"))
	SymDT = pickle.load(open("15SymDaisyProb.LinearSVC", "rb"))
	PIDT = pickle.load(open("16PIDaisyProb.LinearSVC", "rb"))
	EDT = pickle.load(open("17EDaisyProb.LinearSVC", "rb"))
	RomDT = pickle.load(open("18RomDaisyProb.LinearSVC", "rb"))
	RelDT = pickle.load(open("19RelDaisyProb.LinearSVC", "rb"))
	ImpDT = pickle.load(open("20ImpDaisyProb.LinearSVC", "rb"))
