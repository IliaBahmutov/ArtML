...
while running:
    ...
    #Load All DT's
    UKIDT = pickle.load(open("1UKIDaisyProb.DF", "rb"))
    LReDT = pickle.load(open("2LReDaisyProb.DF", "rb"))
    MinDT = pickle.load(open("3MinDaisyProb.DF", "rb"))
    HRenDT = pickle.load(open("4HRenDaisyProb.DF", "rb"))
    ERenDT = pickle.load(open("5ERenDaisyProb.DF", "rb"))
    PopDT = pickle.load(open("6PopDaisyProb.DF", "rb"))
    CFPDT = pickle.load(open("7CFPDaisyProb.DF", "rb"))
    RocDT = pickle.load(open("8RocDaisyProb.DF", "rb"))
    CubDT = pickle.load(open("9CubDaisyProb.DF", "rb"))
    NAPDT = pickle.load(open("10NAPDaisyProb.DF", "rb"))
    NRDT = pickle.load(open("11NRDaisyProb.DF", "rb"))
    AEDT = pickle.load(open("12AEDaisyProb.DF", "rb"))
    BDT = pickle.load(open("13BDaisyProb.DF", "rb"))
    ANMDT = pickle.load(open("14ANMDaisyProb.DF", "rb"))
    SymDT = pickle.load(open("15SymDaisyProb.DF", "rb"))
    PIDT = pickle.load(open("16PIDaisyProb.DF", "rb"))
    EDT = pickle.load(open("17EDaisyProb.DF", "rb"))
    RomDT = pickle.load(open("18RomDaisyProb.DF", "rb"))
    RelDT = pickle.load(open("19RelDaisyProb.DF", "rb"))
    ImpDT = pickle.load(open("20ImpDaisyProb.DF", "rb"))
