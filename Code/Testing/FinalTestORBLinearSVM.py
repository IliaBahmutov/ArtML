...
while running:
	...
	#Load All SVM's
	UKISVM = pickle.load(open("1UKIORBProb.LinearSVC", "rb"))
	LReSVM = pickle.load(open("2LReORBProb.LinearSVC", "rb"))
	MinSVM = pickle.load(open("3MinORBProb.LinearSVC", "rb"))
	HRenSVM = pickle.load(open("4HRenORBProb.LinearSVC", "rb"))
	ERenSVM = pickle.load(open("5ERenORBProb.LinearSVC", "rb"))
	PopSVM = pickle.load(open("6PopORBProb.LinearSVC", "rb"))
	CFPSVM = pickle.load(open("7CFPORBProb.LinearSVC", "rb"))
	RocSVM = pickle.load(open("8RocORBProb.LinearSVC", "rb"))
	CubSVM = pickle.load(open("9CubORBProb.LinearSVC", "rb"))
	NAPSVM = pickle.load(open("10NAPORBProb.LinearSVC", "rb"))
	NRSVM = pickle.load(open("11NRORBProb.LinearSVC", "rb"))
	AESVM = pickle.load(open("12AEORBProb.LinearSVC", "rb"))
	BSVM = pickle.load(open("13BORBProb.LinearSVC", "rb"))
	ANMSVM = pickle.load(open("14ANMORBProb.LinearSVC", "rb"))
	SymSVM = pickle.load(open("15SymORBProb.LinearSVC", "rb"))
	PISVM = pickle.load(open("16PIORBProb.LinearSVC", "rb"))
	ESVM = pickle.load(open("17EORBProb.LinearSVC", "rb"))
	RomSVM = pickle.load(open("18RomORBProb.LinearSVC", "rb"))
	RelSVM = pickle.load(open("19RelORBProb.LinearSVC", "rb"))
	ImpSVM = pickle.load(open("20ImpORBProb.LinearSVC", "rb"))
